...
userID: str = '029081102' #input('User ID [postgres]--> ') or "postgres"
...
db_url: str = f"postgresql+psycopg2://029081102:i*Oys$~)@CECS-Postgresql:5432/2023FallS01"
db_url_display: str = f"postgresql+psycopg2://029081102:********@CECS-Postgresql:5432/2023FallS01"
